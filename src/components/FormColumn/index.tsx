...
import { Column, kanbanData, FormColumnProps } from '../../types';
            ...
            <div className='form-field full-width'>
                {
                    ...
                    <button type='button' className='action-button danger' onClick={(removeColumn)}><FontAwesomeIcon icon={faTrashCan} />Excluir</button>
                }
                <button type='button' className='action-button warning' onClick={(discardChanges)}><FontAwesomeIcon icon={faTimes} />Cancelar</button>
                <button type='submit' className='action-button success' onClick={(saveColumn)}><FontAwesomeIcon icon={faDownload} />Salvar</button>
            </div>
        </form>
    )
}